  ...
  },
  {
    ...
    columns: [
      { title: 'Responsible AI', links: [
        { label: 'How Mimic scores', to: '/mimic/trust' },
        { label: 'Bias testing & audits', to: '/mimic/trust' },
        { label: 'Human-in-the-loop review', to: '/mimic/trust' },
        { label: 'Model & data transparency', to: '/mimic/trust' },
        { label: 'Candidate rights', to: '/mimic/trust' },
      ]},
      { title: 'Compliance', links: [
        { label: 'EU AI Act', to: '/mimic/trust' },
        { label: 'NYC Local Law 144', to: '/mimic/trust' },
        { label: 'Illinois AI Video Interview Act', to: '/mimic/trust' },
        { label: 'GDPR & India DPDP', to: '/mimic/trust' },
        { label: 'EEOC & adverse impact', to: '/mimic/trust' },
      ]},
      { title: 'Security', links: [
        { label: 'Trust Center', to: '/mimic/trust' },
        { label: 'Certifications', to: '/mimic/trust' },
        { label: 'Data residency & retention', to: '/mimic/trust' },
        { label: 'Sub-processors', to: '/mimic/trust' },
        { label: 'Status page', to: '/mimic/trust' },
      ]},
    ],
  },
  {
...
export const PAGES: MktPage[] = [...HUBS, ...SOLUTION_PAGES, ...SOLUTION_BRIEFS]
